...
declare class Sprite_Base extends Sprite {
	...
	public startAnimation(animation: MV.Animation | null, mirror: boolean, delay: number): void;
...
declare class Sprite_Animation extends Sprite {
	...
	public _animation: MV.Animation | null;
	...
	public setup(target: Sprite_Base, animation: MV.Animation | null, mirror: boolean, delay: number): void;
	public remove(): void;
	...
	public processTimingData(timing: MV.Animation.Timing): void;

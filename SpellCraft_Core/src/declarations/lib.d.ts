...
/*!
 * Changed by F_
 * - Renamed the interface 'Window' as 'DOMWindow'.
 * - Commented out the variable 'Window'.
 */
...
interface CompositionEvent extends UIEvent {
    ...
    initCompositionEvent(typeArg: string, canBubbleArg: boolean, cancelableArg: boolean, viewArg: DOMWindow, dataArg: string, locale: string): void;
}
...
interface Document extends Node, GlobalEventHandlers, NodeSelector, DocumentEvent, ParentNode {
    ...
    readonly defaultView: DOMWindow;
    /**
    ...
    createTouch(view: DOMWindow, target: EventTarget, identifier: number, pageX: number, pageY: number, screenX: number, screenY: number): Touch;
...
interface DragEvent extends MouseEvent {
    ...
    initDragEvent(typeArg: string, canBubbleArg: boolean, cancelableArg: boolean, viewArg: DOMWindow, detailArg: number, screenXArg: number, screenYArg: number, clientXArg: number, clientYArg: number, ctrlKeyArg: boolean, altKeyArg: boolean, shiftKeyArg: boolean, metaKeyArg: boolean, buttonArg: number, relatedTargetArg: EventTarget, dataTransferArg: DataTransfer): void;
...
interface FocusEvent extends UIEvent {
    ...
    initFocusEvent(typeArg: string, canBubbleArg: boolean, cancelableArg: boolean, viewArg: DOMWindow, detailArg: number, relatedTargetArg: EventTarget): void;
}
...
interface HTMLFrameElement extends HTMLElement, GetSVGDocument {
    ...
    /**
      ...
      */
    readonly contentWindow: DOMWindow;
    /**
...
interface KeyboardEvent extends UIEvent {
    ...
    initKeyboardEvent(typeArg: string, canBubbleArg: boolean, cancelableArg: boolean, viewArg: DOMWindow, keyArg: string, locationArg: number, modifiersListArg: string, repeat: boolean, locale: string): void;
...
interface MSManipulationEvent extends UIEvent {
    ...
    initMSManipulationEvent(typeArg: string, canBubbleArg: boolean, cancelableArg: boolean, viewArg: DOMWindow, detailArg: number, lastState: number, currentState: number): void;
...
interface MessageEvent extends Event {
    ...
    readonly origin: string;
    readonly ports: any;
    readonly source: DOMWindow;
    initMessageEvent(typeArg: string, canBubbleArg: boolean, cancelableArg: boolean, dataArg: any, originArg: string, lastEventIdArg: string, sourceArg: DOMWindow): void;
}
...
interface MouseEvent extends UIEvent {
    ...
    readonly y: number;
    getModifierState(keyArg: string): boolean;
    initMouseEvent(typeArg: string, canBubbleArg: boolean, cancelableArg: boolean, viewArg: DOMWindow, detailArg: number, screenXArg: number, screenYArg: number, clientXArg: number, clientYArg: number, ctrlKeyArg: boolean, altKeyArg: boolean, shiftKeyArg: boolean, metaKeyArg: boolean, buttonArg: number, relatedTargetArg: EventTarget): void;
}
...
interface UIEvent extends Event {
    ...
    readonly view: DOMWindow;
    initUIEvent(typeArg: string, canBubbleArg: boolean, cancelableArg: boolean, viewArg: DOMWindow, detailArg: number): void;
}
...
interface WheelEvent extends MouseEvent {
    ...
    getCurrentPoint(element: Element): void;
    initWheelEvent(typeArg: string, canBubbleArg: boolean, cancelableArg: boolean, viewArg: DOMWindow, detailArg: number, screenXArg: number, screenYArg: number, clientXArg: number, clientYArg: number, buttonArg: number, relatedTargetArg: EventTarget, modifiersListArg: string, deltaXArg: number, deltaYArg: number, deltaZArg: number, deltaMode: number): void;
...
interface DOMWindow extends EventTarget, WindowTimers, WindowSessionStorage, WindowLocalStorage, WindowConsole, GlobalEventHandlers, IDBEnvironment, WindowBase64 {
    ...
    open(url?: string, target?: string, features?: string, replace?: boolean): DOMWindow;
...
declare var onabort: (this: DOMWindow, ev: UIEvent) => any;
declare var onafterprint: (this: DOMWindow, ev: Event) => any;
declare var onbeforeprint: (this: DOMWindow, ev: Event) => any;
declare var onbeforeunload: (this: DOMWindow, ev: BeforeUnloadEvent) => any;
declare var onblur: (this: DOMWindow, ev: FocusEvent) => any;
declare var oncanplay: (this: DOMWindow, ev: Event) => any;
declare var oncanplaythrough: (this: DOMWindow, ev: Event) => any;
declare var onchange: (this: DOMWindow, ev: Event) => any;
declare var onclick: (this: DOMWindow, ev: MouseEvent) => any;
declare var oncompassneedscalibration: (this: DOMWindow, ev: Event) => any;
declare var oncontextmenu: (this: DOMWindow, ev: PointerEvent) => any;
declare var ondblclick: (this: DOMWindow, ev: MouseEvent) => any;
declare var ondevicelight: (this: DOMWindow, ev: DeviceLightEvent) => any;
declare var ondevicemotion: (this: DOMWindow, ev: DeviceMotionEvent) => any;
declare var ondeviceorientation: (this: DOMWindow, ev: DeviceOrientationEvent) => any;
declare var ondrag: (this: DOMWindow, ev: DragEvent) => any;
declare var ondragend: (this: DOMWindow, ev: DragEvent) => any;
declare var ondragenter: (this: DOMWindow, ev: DragEvent) => any;
declare var ondragleave: (this: DOMWindow, ev: DragEvent) => any;
declare var ondragover: (this: DOMWindow, ev: DragEvent) => any;
declare var ondragstart: (this: DOMWindow, ev: DragEvent) => any;
declare var ondrop: (this: DOMWindow, ev: DragEvent) => any;
declare var ondurationchange: (this: DOMWindow, ev: Event) => any;
declare var onemptied: (this: DOMWindow, ev: Event) => any;
declare var onended: (this: DOMWindow, ev: MediaStreamErrorEvent) => any;
declare var onerror: ErrorEventHandler;
declare var onfocus: (this: DOMWindow, ev: FocusEvent) => any;
declare var onhashchange: (this: DOMWindow, ev: HashChangeEvent) => any;
declare var oninput: (this: DOMWindow, ev: Event) => any;
declare var oninvalid: (this: DOMWindow, ev: Event) => any;
declare var onkeydown: (this: DOMWindow, ev: KeyboardEvent) => any;
declare var onkeypress: (this: DOMWindow, ev: KeyboardEvent) => any;
declare var onkeyup: (this: DOMWindow, ev: KeyboardEvent) => any;
declare var onload: (this: DOMWindow, ev: Event) => any;
declare var onloadeddata: (this: DOMWindow, ev: Event) => any;
declare var onloadedmetadata: (this: DOMWindow, ev: Event) => any;
declare var onloadstart: (this: DOMWindow, ev: Event) => any;
declare var onmessage: (this: DOMWindow, ev: MessageEvent) => any;
declare var onmousedown: (this: DOMWindow, ev: MouseEvent) => any;
declare var onmouseenter: (this: DOMWindow, ev: MouseEvent) => any;
declare var onmouseleave: (this: DOMWindow, ev: MouseEvent) => any;
declare var onmousemove: (this: DOMWindow, ev: MouseEvent) => any;
declare var onmouseout: (this: DOMWindow, ev: MouseEvent) => any;
declare var onmouseover: (this: DOMWindow, ev: MouseEvent) => any;
declare var onmouseup: (this: DOMWindow, ev: MouseEvent) => any;
declare var onmousewheel: (this: DOMWindow, ev: WheelEvent) => any;
declare var onmsgesturechange: (this: DOMWindow, ev: MSGestureEvent) => any;
declare var onmsgesturedoubletap: (this: DOMWindow, ev: MSGestureEvent) => any;
declare var onmsgestureend: (this: DOMWindow, ev: MSGestureEvent) => any;
declare var onmsgesturehold: (this: DOMWindow, ev: MSGestureEvent) => any;
declare var onmsgesturestart: (this: DOMWindow, ev: MSGestureEvent) => any;
declare var onmsgesturetap: (this: DOMWindow, ev: MSGestureEvent) => any;
declare var onmsinertiastart: (this: DOMWindow, ev: MSGestureEvent) => any;
declare var onmspointercancel: (this: DOMWindow, ev: MSPointerEvent) => any;
declare var onmspointerdown: (this: DOMWindow, ev: MSPointerEvent) => any;
declare var onmspointerenter: (this: DOMWindow, ev: MSPointerEvent) => any;
declare var onmspointerleave: (this: DOMWindow, ev: MSPointerEvent) => any;
declare var onmspointermove: (this: DOMWindow, ev: MSPointerEvent) => any;
declare var onmspointerout: (this: DOMWindow, ev: MSPointerEvent) => any;
declare var onmspointerover: (this: DOMWindow, ev: MSPointerEvent) => any;
declare var onmspointerup: (this: DOMWindow, ev: MSPointerEvent) => any;
declare var onoffline: (this: DOMWindow, ev: Event) => any;
declare var ononline: (this: DOMWindow, ev: Event) => any;
declare var onorientationchange: (this: DOMWindow, ev: Event) => any;
declare var onpagehide: (this: DOMWindow, ev: PageTransitionEvent) => any;
declare var onpageshow: (this: DOMWindow, ev: PageTransitionEvent) => any;
declare var onpause: (this: DOMWindow, ev: Event) => any;
declare var onplay: (this: DOMWindow, ev: Event) => any;
declare var onplaying: (this: DOMWindow, ev: Event) => any;
declare var onpopstate: (this: DOMWindow, ev: PopStateEvent) => any;
declare var onprogress: (this: DOMWindow, ev: ProgressEvent) => any;
declare var onratechange: (this: DOMWindow, ev: Event) => any;
declare var onreadystatechange: (this: DOMWindow, ev: ProgressEvent) => any;
declare var onreset: (this: DOMWindow, ev: Event) => any;
declare var onresize: (this: DOMWindow, ev: UIEvent) => any;
declare var onscroll: (this: DOMWindow, ev: UIEvent) => any;
declare var onseeked: (this: DOMWindow, ev: Event) => any;
declare var onseeking: (this: DOMWindow, ev: Event) => any;
declare var onselect: (this: DOMWindow, ev: UIEvent) => any;
declare var onstalled: (this: DOMWindow, ev: Event) => any;
declare var onstorage: (this: DOMWindow, ev: StorageEvent) => any;
declare var onsubmit: (this: DOMWindow, ev: Event) => any;
declare var onsuspend: (this: DOMWindow, ev: Event) => any;
declare var ontimeupdate: (this: DOMWindow, ev: Event) => any;
declare var ontouchcancel: (ev: TouchEvent) => any;
declare var ontouchend: (ev: TouchEvent) => any;
declare var ontouchmove: (ev: TouchEvent) => any;
declare var ontouchstart: (ev: TouchEvent) => any;
declare var onunload: (this: DOMWindow, ev: Event) => any;
declare var onvolumechange: (this: DOMWindow, ev: Event) => any;
declare var onwaiting: (this: DOMWindow, ev: Event) => any;
...
declare function open(url?: string, target?: string, features?: string, replace?: boolean): DOMWindow;
...
declare var onpointercancel: (this: DOMWindow, ev: PointerEvent) => any;
declare var onpointerdown: (this: DOMWindow, ev: PointerEvent) => any;
declare var onpointerenter: (this: DOMWindow, ev: PointerEvent) => any;
declare var onpointerleave: (this: DOMWindow, ev: PointerEvent) => any;
declare var onpointermove: (this: DOMWindow, ev: PointerEvent) => any;
declare var onpointerout: (this: DOMWindow, ev: PointerEvent) => any;
declare var onpointerover: (this: DOMWindow, ev: PointerEvent) => any;
declare var onpointerup: (this: DOMWindow, ev: PointerEvent) => any;
declare var onwheel: (this: DOMWindow, ev: WheelEvent) => any;
declare var indexedDB: IDBFactory;
declare function atob(encodedString: string): string;
declare function btoa(rawString: string): string;
declare function addEventListener(type: "MSGestureChange", listener: (this: DOMWindow, ev: MSGestureEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "MSGestureDoubleTap", listener: (this: DOMWindow, ev: MSGestureEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "MSGestureEnd", listener: (this: DOMWindow, ev: MSGestureEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "MSGestureHold", listener: (this: DOMWindow, ev: MSGestureEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "MSGestureStart", listener: (this: DOMWindow, ev: MSGestureEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "MSGestureTap", listener: (this: DOMWindow, ev: MSGestureEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "MSInertiaStart", listener: (this: DOMWindow, ev: MSGestureEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "MSPointerCancel", listener: (this: DOMWindow, ev: MSPointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "MSPointerDown", listener: (this: DOMWindow, ev: MSPointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "MSPointerEnter", listener: (this: DOMWindow, ev: MSPointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "MSPointerLeave", listener: (this: DOMWindow, ev: MSPointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "MSPointerMove", listener: (this: DOMWindow, ev: MSPointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "MSPointerOut", listener: (this: DOMWindow, ev: MSPointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "MSPointerOver", listener: (this: DOMWindow, ev: MSPointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "MSPointerUp", listener: (this: DOMWindow, ev: MSPointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "abort", listener: (this: DOMWindow, ev: UIEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "afterprint", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "beforeprint", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "beforeunload", listener: (this: DOMWindow, ev: BeforeUnloadEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "blur", listener: (this: DOMWindow, ev: FocusEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "canplay", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "canplaythrough", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "change", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "click", listener: (this: DOMWindow, ev: MouseEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "compassneedscalibration", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "contextmenu", listener: (this: DOMWindow, ev: PointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "dblclick", listener: (this: DOMWindow, ev: MouseEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "devicelight", listener: (this: DOMWindow, ev: DeviceLightEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "devicemotion", listener: (this: DOMWindow, ev: DeviceMotionEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "deviceorientation", listener: (this: DOMWindow, ev: DeviceOrientationEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "drag", listener: (this: DOMWindow, ev: DragEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "dragend", listener: (this: DOMWindow, ev: DragEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "dragenter", listener: (this: DOMWindow, ev: DragEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "dragleave", listener: (this: DOMWindow, ev: DragEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "dragover", listener: (this: DOMWindow, ev: DragEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "dragstart", listener: (this: DOMWindow, ev: DragEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "drop", listener: (this: DOMWindow, ev: DragEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "durationchange", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "emptied", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "ended", listener: (this: DOMWindow, ev: MediaStreamErrorEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "focus", listener: (this: DOMWindow, ev: FocusEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "hashchange", listener: (this: DOMWindow, ev: HashChangeEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "input", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "invalid", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "keydown", listener: (this: DOMWindow, ev: KeyboardEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "keypress", listener: (this: DOMWindow, ev: KeyboardEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "keyup", listener: (this: DOMWindow, ev: KeyboardEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "load", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "loadeddata", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "loadedmetadata", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "loadstart", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "message", listener: (this: DOMWindow, ev: MessageEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "mousedown", listener: (this: DOMWindow, ev: MouseEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "mouseenter", listener: (this: DOMWindow, ev: MouseEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "mouseleave", listener: (this: DOMWindow, ev: MouseEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "mousemove", listener: (this: DOMWindow, ev: MouseEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "mouseout", listener: (this: DOMWindow, ev: MouseEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "mouseover", listener: (this: DOMWindow, ev: MouseEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "mouseup", listener: (this: DOMWindow, ev: MouseEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "mousewheel", listener: (this: DOMWindow, ev: WheelEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "offline", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "online", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "orientationchange", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "pagehide", listener: (this: DOMWindow, ev: PageTransitionEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "pageshow", listener: (this: DOMWindow, ev: PageTransitionEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "pause", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "play", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "playing", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "pointercancel", listener: (this: DOMWindow, ev: PointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "pointerdown", listener: (this: DOMWindow, ev: PointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "pointerenter", listener: (this: DOMWindow, ev: PointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "pointerleave", listener: (this: DOMWindow, ev: PointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "pointermove", listener: (this: DOMWindow, ev: PointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "pointerout", listener: (this: DOMWindow, ev: PointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "pointerover", listener: (this: DOMWindow, ev: PointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "pointerup", listener: (this: DOMWindow, ev: PointerEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "popstate", listener: (this: DOMWindow, ev: PopStateEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "progress", listener: (this: DOMWindow, ev: ProgressEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "ratechange", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "readystatechange", listener: (this: DOMWindow, ev: ProgressEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "reset", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "resize", listener: (this: DOMWindow, ev: UIEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "scroll", listener: (this: DOMWindow, ev: UIEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "seeked", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "seeking", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "select", listener: (this: DOMWindow, ev: UIEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "stalled", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "storage", listener: (this: DOMWindow, ev: StorageEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: "submit", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "suspend", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "timeupdate", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "unload", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "volumechange", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "waiting", listener: (this: DOMWindow, ev: Event) => any, useCapture?: boolean): void;
declare function addEventListener(type: "wheel", listener: (this: DOMWindow, ev: WheelEvent) => any, useCapture?: boolean): void;
declare function addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
type AAGUID = string;

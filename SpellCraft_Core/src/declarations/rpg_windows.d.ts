...
declare class Window_Selectable extends Window_Base {
	...
	public setHelpWindowItem(item: MV.Item | null): void;
...
declare class Window_Help extends Window_Base {
	...
	public clear(): void;
	public setItem(item: MV.Item | null): void;
	public refresh(): void;
}
...
declare class Window_ItemList extends Window_Selectable {
	...
	public _data: (MV.Item | MV.Weapon | MV.Armor | null)[];
	...
	public spacing(): number;
	public maxItems(): number;
	public item(): MV.Item | MV.Weapon | MV.Armor | null;
	public isCurrentItemEnabled(): boolean;

	public includes(item: MV.Item | MV.Weapon | MV.Armor): boolean;
	public needsNumber(): boolean;
	public isEnabled(item: MV.Item | MV.Weapon | MV.Armor): boolean;
	...
	public drawItemNumber(item: MV.Item | MV.Weapon | MV.Armor, x: number, y: number, width: number): void;
...
declare class Window_SkillList extends Window_Selectable {
	...
	public spacing(): number;
	public maxItems(): number;
	public item(): MV.Skill | null;
	public isCurrentItemEnabled(): boolean;

	public includes(item: MV.Skill | null): boolean;
	public isEnabled(item: MV.Skill): void;
	...
	public drawSkillCost(skill: MV.Skill, x: number, y: number, width: number): void;
...
declare class Window_EquipSlot extends Window_Selectable {
	...
	public maxItems(): number;
	public item(): MV.Weapon | MV.Armor | null;
...
declare class Window_EquipItem extends Window_ItemList {
	...
	public includes(item: MV.Weapon | MV.Armor): boolean;
	public isEnabled(item: MV.Weapon | MV.Armor): boolean;
...
declare class Window_ShopBuy extends Window_Selectable {
	...
	public _data: (MV.Item | MV.Weapon | MV.Armor)[];
	...
	public windowWidth(): number;
	public maxItems(): number;
	public item(): MV.Item | MV.Weapon | MV.Armor;
	public setMoney(money: number): void;
	public isCurrentItemEnabled(): boolean;
	public price(item: MV.Item | MV.Weapon | MV.Armor): number;
	public isEnabled(item: MV.Item | MV.Weapon | MV.Armor): boolean;
...
declare class Window_ShopSell extends Window_ItemList {
	...
	public isEnabled(item: MV.Item | MV.Weapon | MV.Armor | null): boolean;
}
...
declare class Window_ShopNumber extends Window_Selectable {
	...
	public _item: MV.Item | MV.Weapon | MV.Armor | null;
	public _max: number;
	public _price: number;
	...
	public setup(item: MV.Item | MV.Weapon | MV.Armor | null, max: number, price: number): void;
...
declare class Window_ShopStatus extends Window_Base {
	...
	public setItem(item: MV.Item | MV.Weapon | MV.Armor | null): void;
	...
	public drawActorParamChange(x: number, y: number, actor: Game_Actor, item1: MV.Weapon | MV.Armor | null): void;

	public paramId(): number;
	public currentEquippedItem(actor: Game_Actor, etypeId: number): MV.Weapon | MV.Armor | null;
...
declare class Window_EventItem extends Window_ItemList {
	...
	public isEnabled(item: MV.Item): boolean;
...
declare class Window_BattleLog extends Window_Selectable {
	...
	public displayAction(subject: Game_Battler, item: MV.Skill | MV.Item): void;

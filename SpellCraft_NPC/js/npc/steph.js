...
$gameMessage.add("My name is steph. What do you want??");

$gameMessage.setChoices(['yes', 'Goodbye'], 0, 1);

$gameMessage.setChoiceCallback(function (val)
{
	switch (val)
	{
		case 0:
		...
		case 1:
			$gameMessage.newPage();
			//$gameMessage.setFaceImage(me.data.characterName, me.data.characterIndex);
			$gameMessage.add("See you around");
			break;
	};
});
